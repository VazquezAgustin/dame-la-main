...
export const LIGHTNING_QUESTIONS = [
  ...
  // — Cultura general —
  { question: "¿Cuántos lados tiene un octógono?", answer: "8" },
  { question: "¿Cuál es el océano más grande del mundo?", answer: "El Pacífico" },
  ...
  { question: "¿Qué instrumento toca un pianista?", answer: "El piano" },
  { question: "¿Cuál es el metal más caro del mundo?", answer: "El rodio (o el oro, aceptar ambos)" },
  { question: "¿Cuántos centímetros tiene un metro?", answer: "100" },
  { question: "¿De qué color es el cielo despejado de día?", answer: "Azul" },
  { question: "¿Qué animal simboliza la paz?", answer: "La paloma" },
  { question: "¿Cuántos jugadores hay en un equipo de rugby union?", answer: "15" },
  { question: "¿Cuál es la fruta más consumida del mundo?", answer: "El tomate (botánicamente, o el plátano — aceptar ambos)" },
  ...
  // — Fútbol y deporte —
  { question: "¿En qué posición jugaba Maradona?", answer: "Mediapunta / enganche" },
  { question: "¿Cuántos metros mide un gol de fútbol de ancho?", answer: "7,32 metros" },
  { question: "¿De qué país es la selección conocida como 'La Furia Roja'?", answer: "España" },
  { question: "¿Cuántos sets se juegan como máximo en tenis masculino de Grand Slam?", answer: "5" },
  ...
  { question: "¿En qué país nació Lionel Messi?", answer: "Argentina" },
  ...
  { question: "¿Cuál es la distancia oficial de un maratón en kilómetros?", answer: "42,195 km" },
  { question: "¿En qué deporte compite Novak Djokovic?", answer: "Tenis" },
  { question: "¿Cuántos jugadores hay en un equipo de béisbol?", answer: "9" },
  { question: "¿Cómo se llama el estadio del Real Madrid?", answer: "Santiago Bernabéu" },
  { question: "¿En qué deporte se usan palos, banderas y hoyos?", answer: "Golf" },
  ...
  { question: "¿Quién canta 'Despacito'?", answer: "Luis Fonsi (feat. Daddy Yankee)" },
  { question: "¿Cómo se llama el personaje principal de 'El Señor de los Anillos'?", answer: "Frodo Bolsón" },
  { question: "¿De qué color es el traje de Spider-Man?", answer: "Rojo y azul" },
  { question: "¿Cómo se llama la serie de zombies de AMC?", answer: "The Walking Dead" },
  { question: "¿Quién es el cantante de la banda Coldplay?", answer: "Chris Martin" },
  { question: "¿En qué ciudad viven los personajes de 'Friends'?", answer: "Nueva York" },
  { question: "¿Cómo se llama la madre de Jon Snow en 'Game of Thrones'?", answer: "Lyanna Stark" },
  { question: "¿Cuántas películas tiene la saga 'El Padrino'?", answer: "3" },
  { question: "¿Qué banda argentina cantó 'La Bomba'?", answer: "Los Auténticos Decadentes" },

  // — España y Argentina —
  { question: "¿Cuál es la moneda oficial de España?", answer: "El euro" },
  { question: "¿En qué ciudad española está la Sagrada Familia?", answer: "Barcelona" },
  { question: "¿Cómo se llama el presidente del gobierno español en 2024?", answer: "Pedro Sánchez" },
  ...
  { question: "¿En qué ciudad argentina nació el papa Francisco?", answer: "Buenos Aires" },
  { question: "¿Cómo se llama el palacio de la realeza española en Madrid?", answer: "Palacio Real" },
  { question: "¿En qué región española es famosa la paella?", answer: "Valencia" },
  { question: "¿Qué animal aparece en el escudo de Argentina?", answer: "El sol (Sol de Mayo)" },
  { question: "¿Cómo se llama la famosa calle comercial de Madrid?", answer: "La Gran Vía" },

  // — Tecnología y ciencia —
  { question: "¿Qué empresa creó el iPhone?", answer: "Apple" },
  { question: "¿Cuántos bits tiene un byte?", answer: "8" },
  { question: "¿Qué red social tiene un pajarito como logo (antes de cambiar)?", answer: "Twitter (ahora X)" },
  { question: "¿Quién fundó Tesla?", answer: "Elon Musk (cofundador junto a otros)" },
  { question: "¿Qué significa 'www' en una dirección web?", answer: "World Wide Web" },
  { question: "¿Cuántos colores tiene la bandera de Google?", answer: "4 (rojo, azul, amarillo y verde)" },
  { question: "¿Qué planeta tiene los anillos más famosos?", answer: "Saturno" },
  { question: "¿A qué velocidad viaja la luz (aprox)?", answer: "300.000 km/s" },
...
export const ESTIMATION_QUESTIONS = [
  ...
  { question: "¿En qué año nació Michael Jackson?", answer: 1958 },
  ...
  { question: "¿Cuántos jugadores tienen en total los dos equipos en el campo en un partido de fútbol?", answer: 22 },
  { question: "¿Cuántos kilómetros tiene la Gran Muralla China aproximadamente?", answer: 21196 },
  { question: "¿Cuántos años vivió Pablo Picasso?", answer: 91 },
  { question: "¿Cuántos países componen el Reino Unido?", answer: 4 },
  ...
  { question: "¿Cuántos metros tiene una piscina olímpica?", answer: 50 },
  ...
  { question: "¿En qué año se fundó la UEFA?", answer: 1954 },
  { question: "¿Cuántos goles marcó Ronaldo (CR7) en toda su carrera hasta 2024?", answer: 900 },
  { question: "¿En cuántos Mundiales jugó Diego Maradona?", answer: 4 },
];
